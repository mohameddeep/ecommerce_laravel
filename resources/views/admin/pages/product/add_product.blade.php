...
@endif
                ...
                <form class="forms-sample" method="post" action="{{ route('admin_product.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="discount" class="form-control" id="exampleInputEmail3" placeholder="discount">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <select name="catogry_id" class="form-control" id="exampleSelectGender">
                        <option selected>select your catogry</option>
