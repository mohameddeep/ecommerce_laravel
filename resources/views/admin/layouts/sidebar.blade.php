<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{ route('admin_catogry.index') }}">
          <span class="menu-icon">
            <i class="mdi mdi-speedometer"></i>
          </span>
          <span class="menu-title">catogry</span>
        </a>
      </li>
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{ route('admin_product.index') }}">
          <span class="menu-icon">
            <i class="mdi mdi-speedometer"></i>
          </span>
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{ route('admin_order.index') }}">
          <span class="menu-icon">
            <i class="mdi mdi-speedometer"></i>
          </span>
